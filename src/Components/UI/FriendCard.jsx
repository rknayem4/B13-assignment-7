...
const FriendCard = ({ data }) => {
  ...
  return (
    <Link to={`/${id}`} className="p-4 shadow max-w-80 flex flex-col justify-center items-center space-y-3 rounded-2xl transition-transform duration-500 hover:scale-105">
